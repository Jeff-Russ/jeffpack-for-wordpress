...
include_once 'wp_classesPluginData.php';
include_once 'wp_classesSettingsHelper.php';
...
if ( ! class_exists('WpPlugin')) {
	 ...
	 * 
	 */
	class WpPlugin extends SettingsHelper { # extends PluginData, PersistArgs, HelperModule
