...
// Checks if directory exists
  ...
  !file_exists($jp_plugin->info['themes']['active_theme_dir'] . $scss_dir_setting) || 
  !file_exists($jp_plugin->info['themes']['active_theme_dir'] . $css_dir_setting)
) {
  function wpscss_settings_error(){
      echo '<div class="error">
       ...
       . $jp_plugin->info['themes']['active_theme_dir'] . $scss_dir_setting .
      '</div>';
...
$wpscss_settings = array(
  'scss_dir'  =>  $jp_plugin->info['themes']['active_theme_dir'] . $scss_dir_setting,
  'css_dir'   =>  $jp_plugin->info['themes']['active_theme_dir'] . $css_dir_setting,
