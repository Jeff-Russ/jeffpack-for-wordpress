<?php
/**
 * PluginSettingsHelper helps maintain a plugin options page as well as access options 
 ...
 * @license     GPL-2.0
 */
if ( ! class_exists('PluginSettingsHelper')) {
	/**
	 * PluginSettingsHelper class is a collection of methods to help maintain a plugin 
	 ...
	 * 
	 */
	class PluginSettingsHelper extends PluginData { # extends PersistArgs extends HelperModule
