...
include_once 'jr_wp_lib/PluginData.php';
include_once 'jr_wp_lib/PluginSettingsHelper.php';

if ( ! class_exists('WpPluginBase') ) { class WpPluginBase extends PluginSettingsHelper {}
	/**
